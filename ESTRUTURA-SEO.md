...
- Botão com o **link do site** (`nr13autodocs.com.br`) no rodapé da caixa.
...
1. Registrar o domínio definitivo e **trocar `nr13autodocs.com.br`** se for outro (canonicals, sitemap, JSON-LD).
